...
public class BackgroundWorker extends AsyncTask<String,Void,String> {
    ...
    protected String doInBackground(String... params) {
        ...
        String login_url = "http://192.168.64.2/login.php";
        String register_url = "http://192.168.64.2/register.php";
        if(type.equals("login")) {
            try {
                ...
                String post_data = URLEncoder.encode("student_No","UTF-8")+"="+URLEncoder.encode(user_name,"UTF-8")+"&"
